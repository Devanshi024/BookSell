...
import Register from "../pages/registrationSection";
...
import BookList from "../pages/listBookSection/showBooks";
import Cart from "../pages/cartSection/cart";
import UpdateProfile from "../pages/profileUpdateSection/index";
